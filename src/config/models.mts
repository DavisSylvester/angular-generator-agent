...
export type AgentRole = `planning` | `codegen` | `validation`;
...
export const FALLBACK_TIERS: readonly FallbackTier[] = [
  { provider: `ollama`, role: `codegen`, model: `qwen3-coder-next`, temperature: 0.2, maxIterations: 20 },
  { provider: `openai`, role: `codegen`, model: `gpt-4.1`, temperature: 0.2, maxIterations: 16 },
  { provider: `anthropic`, role: `codegen`, model: `claude-sonnet-4-6`, temperature: 0.2, maxIterations: 16 },
];
