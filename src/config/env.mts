...
const envSchema = z.object({
  ...
  // Google API (Gemini — used for Stitch design generation)
  ...
  // Build validation
  PLAYWRIGHT_VALIDATION_ELEMENTS: z.coerce.number().int().min(1).max(20).default(5),
  ...
  LANGSMITH_PROJECT: z.string().default(`angular-generator-agent`),
});
